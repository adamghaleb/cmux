<h1 align="center">fadicode</h1>
<p align="center">A Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents</p>

<p align="center">
  <a href="https://github.com/manaflow-ai/fadicode/releases/latest/download/fadicode-macos.dmg">
    <img src="./docs/assets/macos-badge.png" alt="Download fadicode for macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <img src="./docs/assets/main-first-image.png" alt="fadicode screenshot" width="900" />
</p>

<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Demo video</a> · <a href="https://cmux.dev/blog/zen-of-cmux">The Zen of fadicode</a>
</p>
...
Open the `.dmg` and drag fadicode to your Applications folder. fadicode auto-updates via Sparkle, so you only need to download once.

### Homebrew

```bash
brew tap manaflow-ai/fadicode
brew install --cask fadicode
```

To update later:

```bash
brew upgrade --cask fadicode
```
...
fadicode is not prescriptive about how developers hold their tools. It's a terminal and browser with a CLI, and the rest is up to you.

fadicode is a primitive, not a solution. It gives you a terminal, a browser, notifications, workspaces, splits, tabs, and a CLI to control all of it. fadicode doesn't force you into an opinionated way to use coding agents. What you build with the primitives is yours.
