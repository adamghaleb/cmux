...
final class WindowToolbarController: NSObject, NSToolbarDelegate {
    private let commandItemIdentifier = NSToolbarItem.Identifier("fadicode.focusedCommand")
    ...
    private func attach(to window: NSWindow) {
        ...
        let toolbar = NSToolbar(identifier: NSToolbar.Identifier("fadicode.toolbar"))
