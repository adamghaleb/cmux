  ...
  return (
    <>
      ...
      <p>
        ...
        once. Claude Code, Codex, and other tools each in their own terminal.
        Keeping track of which ones need attention and switching between them
        quickly is the problem cmux solves.
      </p>

      <h2>Key features</h2>
      <ul>
        <li>
          <strong>Vertical tabs</strong> : see all your terminals at a glance in
          a sidebar
        </li>
        <li>
          <strong>Notification rings</strong> : tabs flash when an agent needs
          your input
        </li>
        <li>
          <strong>Split panes</strong> : horizontal and vertical splits within
          each workspace
        </li>
        <li>
          <strong>Socket API</strong> : programmatic control for creating tabs
          and sending input
        </li>
        <li>
          <strong>GPU-accelerated</strong> : powered by libghostty for smooth
          rendering
        </li>
      </ul>
